...
import { add, subtract, multiply ,mod } from './mathFunctions.js';
import divide from './mathFunctions.js'; // Default export does not need curly braces
...
// Dynamic import
// import('./mathFunctions.js').then(mathModule => {
